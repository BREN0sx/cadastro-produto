...
dados = ler_cadastro.read()
ler_cadastro()
name = ""; desc = ""; session = ""; stock = ""; price = ""
nameC = ""; descC = ""; sessionC = ""; stockC = ""; priceC = ""

while True:
    #arquivo_cadastro = open("dados.txt", 'r', encoding="utf-8")
    ...
    arquivo_cadastr = open("dados.txt", 'w+', encoding="utf-8")
    arquivo_cadastr.write("%s" %dados)
    arquivo_cadastr.close()